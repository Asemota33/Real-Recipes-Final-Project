            ...
            if (!context.Recipes.Any())
            {
                context.Recipes.AddRange(
                            new Recipes
                            {
                                ...
                                time = new DateTime(2019, 3, 15, 12, 12, 21),
                                pictureName = "Jollof.jpg"
                            },
                    new Recipes
                    {
                    ...
                    new Recipes
                    {
                        ...
                        ingredients3 = "3 killograms of all of it",
                        review = "This is the best recipe ever",
                        time = new DateTime(2019, 12, 05, 2, 42, 21),
                        pictureName = "peanutButterJelly.jpg"
                    ...
                    new Recipes
                    {
                        ...
                        ingredients3 = "3 killograms of all of it",
                        review = "This is the best recipe ever",
                        time = new DateTime(2019, 8, 11, 11, 15, 21),
                        pictureName = "Spaghetti-and-Meatballs-SpendWithPennies-4.jpg"
